...
class BBB_Traj(object):
    ...
    def build_graph_dropout(self, keep_prob):
        ...
        with tf.variable_scope("RCNN", reuse=tf.AUTO_REUSE):
            ...
            dense5 = tf.layers.dense(drop6, 3, activation=tf.nn.tanh, name='dense5')
            self.outputs = dense5
    ...
    def train_model(self):
        ...
        learning_rate = td.poly_inverse_time_decay(0.005, global_step, decay_steps=1, decay_rate=0.0001, power=0.75)
    ...
    def test_model(self, draw_figure=False, pre_trained=False):
        ...
        np.save('drop_{}_l2.npy'.format(self.sector), self.l2_new)
...
if __name__ == '__main__':
    ...
    cfg['save_path'] = './Drop_{}_{}_epoch_{}'.format(cfg['date'], cfg['sector'], cfg['epoch'])
