...
class BBB_Traj(object):
    ...
    def build_graph(self, keep_prob):
        ...
        with tf.variable_scope("RCNN", reuse=tf.AUTO_REUSE):
            ...
            dense5 = tf.layers.dense(dense4, 2, activation=tf.nn.tanh, name='dense5')
            self.outputs = dense5
    ...
    def test_model(self, draw_figure=False, pre_trained=False):
        ...
        np.save('2ddet_{}_l2.npy'.format(self.sector), self.l2_new)
...
if __name__ == '__main__':
    ...
    cfg['save_path'] = './Det2d_{}_{}_epoch_{}'.format(cfg['date'], cfg['sector'], cfg['epoch'])
